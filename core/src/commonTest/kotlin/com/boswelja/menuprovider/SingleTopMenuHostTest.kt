...
class SingleTopMenuHostTest {

    private lateinit var cumulativeMenuHost: SingleTopMenuHost

    @BeforeTest
    fun setUp() {
        cumulativeMenuHost = SingleTopMenuHost()
    }
    ...
    fun whenMenuItemsAdded_stateIsUpdated() {
        ...
        assertFalse(cumulativeMenuHost.menuItems.containsAll(firstBatch))
